"""Patch Intent Twin — SCAFFOLD STUB.

Company lens: Cursor / Anysphere (independent; no affiliation).
Bottleneck: giving coding agents increasing repository/tool authority without sacrificing reviewability, intent alignment, or developer trust
...
class PatchIntentTwin:
    ...
    - `evaluate(req)` returns a PatchIntentTwinReceipt
